                    ...
                    <div class="bag__column bag__header mobile__none">
                        ...
                        <div class="administration-inf">
                            <img src="<?php
                                        ...
                                        ?>" alt="avatar">
                            <form action="actions/photo.php" class="ava-form" method="post" enctype="multipart/form-data">
                                <input type="file" id="photo" name="photo">
                                <input type="hidden" name="id" value="<?= $_SESSION['user']['id'] ?>">
                                <button type="submit" class="btn-card">Сменить фото</button>
                                <?php
                                if (!empty($_SESSION['error']['photo'])) {
                                    echo $_SESSION['error']['photo'];
                                    unset($_SESSION['error']['photo']);
                                }
                                ?>
                            </form>

                            <div class="inform__user">
