        ...
        <div class="container">
            <div class="form">
                ...
                <div class="form__body">
                    <form enctype="multipart/form-data" action="actions/add.php" method="post" name="sign-up">


                        <!-- <a href="#" class="add__img">Добавить картинку</a> -->
                        <input type="file" class="reggg" id="inputGroupFile01" name="avatar">
                        <label for="name"></label><input type="text" name="nametov" id="name" placeholder="Название">
                        <label for="description"></label><input type="text" name="description" id="description" placeholder="Описание">
                        <label for="price"></label><input type="number" name="price" id="price" placeholder="цена товара">
                        <input class="reggg" type="submit" value="Добавить товар" name="sign-up">
                    </form>
                </div>
            </div>
        </div>
